...
A análise a ser apresentada é como se fosse a seção "Resultados" de um artigo no formato "Introdução", "Método", **"Resultados"**, "Discussão" e "Conclusão".
...
* `english` do pacote `languageR` (ou qualquer outro dado desse pacote. Após carregar o pacote, rode `data(package="languageR")`para ver a lista com descriçào dos dados disponíveis)
